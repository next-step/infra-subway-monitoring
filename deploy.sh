...
function start_app(){
  ...
  nohup java -jar -Djava.security.egd=file:/dev/./urandom -Duser.timezone="Asia/Seoul" -Dspring.profiles.active=local $(find ./build -name "*jar") 1> $HOME/application.log 2>&1  &
