...
public class AuthController {
    ...
    private static final String LOGIN_MESSAGE = "[ {} ] 님이 로그인 했습니다.";
    ...
    private void log(TokenRequest request) {
        CONSOLE_LOGGER.info(LOGIN_MESSAGE, request.getEmail());
        FILE_LOGGER.info(LOGIN_MESSAGE, request.getEmail());
    }
