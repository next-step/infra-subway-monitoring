...
public class PathService {
    private static final Logger jsonEventLogger = LoggerFactory.getLogger("json");
    ...
    private SubwayPath convertSubwayPath(GraphPath graphPath) {
        ...
        jsonEventLogger.info("{}~{} : {}",
                kv("출발지", graphPath.getStartVertex()),
                kv("도착지", graphPath.getEndVertex()),
                kv("경로", stations)
        );
